...
import LandingCourse from "../../Assets/Images/LandingCourse.svg";
import LandingClassroom from "../../Assets/Images/LandingClassroom.svg";
import LandingSkill from "../../Assets/Images/LandingSkill.svg";
import LandingWebinar from "../../Assets/Images/LandingWebinar.svg";
import checkbox from "../../Assets/Images/checkboxLanding.svg";
...
export default function LandingPage() {
  ...
  //   setIsLoginOpen(false); // Close the dialog
  ...
  const handleCourseClick = () => {
    console.log("course sqhuighluhk")
  ...
  return (
    <div className="landingPageSection">
      <header className="landingPageHeader">
        <div className="logo">
          <img src={SoulLogo} alt="Logo" />
        </div>
        <div className="landingPageNav">
          <div className="navPointer" onClick={handleCourseClick}>Courses</div>
          <div className="navPointer" onClick={handleWebinarClick}>Webinars</div>
          <div className="navPointer" onClick={handleContactClick}>Contact Us</div>
          <div className="navLoginButton" onClick={handleLoginClick}>
            Login
          </div>
        </div>
      </header>
      <div className="mainSection">
        ...
        <div className="landingCourse">
          <div className="landingCourseDetails">
            <div className="landingCourseHeader">Elevate Your Learning</div>
            <div className="landingCourseHeaderSecondary">
              with Our Online Courses
            </div>
            <div className="landingParagraph">
              At our online learning platform, we provide two distinct types of
              courses designed to meet your educational needs: Live Classroom
              Programs and Skill Programs. Whether you're seeking an
              interactive, real-time learning environment or looking to build
              specific skills at your own pace, we have the perfect solution for
              you.
            </div>
            <div className="browseCourse" onClick={handleLoginClick}>
              Get Started
              <svg
                width="16"
                height="16"
          ...
          <div>
            <img src={LandingCourse} alt="" />
          </div>
        </div>

        {/*CLASSROOM PROGRAM */}
        <div className="LandingPrograms">
          <div>
            <img src={LandingClassroom} alt="" />
          </div>
          <div className="landingClassDetails">
            <div className="landingClassHeader">
              Live Classroom <span style={{ color: "#000" }}>Programs</span>
            </div>
            <div className="landingClassHeaderSecondary">
              Learn from the Best
            </div>
            <div className="landingDarkParagraph">
              Experience the best of both worlds with our Live Classroom
              Programs. These courses offer a dynamic, real-time learning
              environment where you can interact directly with instructors and
              peers.
            </div>
            <div className="landingTODOList">
              <div className="landingList">
                <div style={{ display: "contents" }}>
                  <img src={checkbox} alt="" />
                </div>
                <div>
                  <span style={{ fontWeight: "600" }}>Live Sessions:</span> Join
              ...
              <div className="landingList">
                ...
                <div>
                  <span style={{ fontWeight: "600" }}>
                    Live Test and Mock Test:
                  </span>{" "}
                  Get access to live tests and mock tests.
                </div>
              </div>
              <div className="landingList">
                <div style={{ display: "contents" }}>
                ...
                <div>
                  ...
                  Engage in discussions, group activities, and networking with
                  classmates.
                </div>
              </div>
            </div>
            <div className="exploreButton" onClick={handleCourseClick}>
              Explore
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="17"
        ...
        <div className="landingSkill">
          <div className="landingSkillDetails">
            <div className="landingSkillHeader">
              Skill <span style={{ color: "#000" }}>Programs</span>
            </div>
            <div className="landingSkillHeaderSecondary">
            ...
            <div className="landingTODOList">
              <div className="landingList">
                ...
                <div>
                  ...
                  Dive deep into specific skills with comprehensive course
                  materials.
                </div>
              </div>
              <div className="landingList">
                ...
                <div>
                  <span style={{ fontWeight: "600" }}>Focused Content:</span>{" "}
                  Get access to live tests and mock tests.
                </div>
              </div>
              <div className="landingList">
          ...
          <div>
            <img src={LandingSkill} alt="" />
          </div>
        </div>

        {/*WEBINARS */}

        <div className="landingWebinar">
          <div className="landingWebinarDetails">
            <div className="landingWebinarHeader">Get Expert Insights from</div>
            <div className="landingWebinarHeaderSecondary">
              our<span style={{ color: "#219EBC" }}>&nbsp;&nbsp;Webinars</span>
            </div>
            <div className="landingDarkParagraph">
              Stay ahead of the curve with our Webinars, featuring industry
              experts and thought leaders who share the latest trends, insights,
              and best practices.
            </div>
            <div
              style={{
            ...
            >
              <div className="exploreButton" onClick={handleWebinarClick}>
                Explore
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="17"
          ...
          <div className="imgWebinar">
            <img src={LandingWebinar} alt="" />
          </div>
        </div>
