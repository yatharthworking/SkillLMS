...
function CompletedBatch({ batches }) {
         ...
         {batches.length === 0 ? (
            ...
            <tbody>
                ...
                <tr key={batch.batchId}>
                    ...
                    {/* <td>
                    <img src={Action} alt="Action" style={{ cursor: 'pointer' }} onClick={handleActionClick} />
                    <Menu anchorEl={menuAnchor} open={Boolean(menuAnchor)} onClose={handleMenuClose}>
                        <MenuItem className='MenuItem'><EditOutlinedIcon />Edit</MenuItem>
                        <MenuItem className='MenuItem'><SettingsOutlinedIcon />Manage</MenuItem>
                        <MenuItem style={{ color: 'red' }} className='MenuItem'><DeleteOutlinedIcon />Delete</MenuItem>
                    </Menu>
                    </td> */}
                </tr>
                ))}
